...
export function locationHashStore(keyFor) {
    return {
...
export function localStorageStore(keyFor) {
    return {
...
export function resolveIdStore(choice, keyFor) {
    const c = choice ?? 'locationHash';
    if (c === 'locationHash')
        return locationHashStore(keyFor);
    if (c === 'localStorage')
        return localStorageStore(keyFor);
    return c;
}
/**
